...
const Card = ({obj}) => {
    let {setitem,setCarts}=useContext(CartContext)
    let handleCart=()=>{
  ...
  return (
    <div className='w-62.5 h-75 bg-amber-50 flex flex-col justify-center items-center  gap-1 rounded-[12px] caret-transparent'>
        ...
        <button className='bg-gray-500 hover:bg-amber-600 py-0.5 p-1.5 rounded-full cursor-pointer fon' onClick={handleCart}>Add to cart</button>
